...
const Index = () => {
  return (
    <>
      <Head>
        <title>About Team | Panchtatv</title>
      ...
      <Container className={"mb-5"} style={{ marginTop: 32 }}>
        ...
        <Row className={"mt-5"}>
          ...
          <Col lg={3} md={4} sm={6} xs={12}>
            ...
            <p className={"text-muted text-center"}>Founder / World Traveler</p>
            <div
              className={"d-flex justify-content-center"}
              style={{ marginBottom: 33 }}
            >
          ...
          <Col lg={3} md={4} sm={6} xs={12}>
            ...
            <p className={"text-muted text-center"}>Design Consultant</p>
            <div
              className={"d-flex justify-content-center"}
              style={{ marginBottom: 33 }}
            >
          ...
          <Col lg={3} md={4} sm={6} xs={12}>
            ...
            <p className={"text-muted text-center"}>Digital Marketing Guru</p>
            <div
              className={"d-flex justify-content-center"}
              style={{ marginBottom: 33 }}
            >
          ...
          <Col lg={3} md={4} sm={6} xs={12}>
            ...
            <p className={"text-muted text-center"}>Director of Operations</p>
            <div
              className={"d-flex justify-content-center"}
              style={{ marginBottom: 33 }}
            >
          ...
          <Col lg={3} md={4} sm={6} xs={12}>
            ...
            <p className={"text-muted text-center"}>Customer Service Manager</p>
            <div
              className={"d-flex justify-content-center"}
              style={{ marginBottom: 33 }}
            >
